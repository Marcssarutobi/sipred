<template>
    <div class="dashboard-main-body">
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <h6 class="fw-semibold mb-0">Liste des Fournisseur</h6>
            <ul class="d-flex align-items-center gap-2">
                ...
                <li>-</li>
                <li class="fw-medium">Liste des Fournisseur</li>
            </ul>
        </div>
        ...
        <div class="card">
            <div class="card-header d-flex flex-wrap align-items-center justify-content-between gap-3">
                <div></div>
                <button @click="showModal" class="btn btn-sm btn-primary-600"><i class="ri-add-line"></i> Ajouter un fournisseur</button>
            </div>
            <div class="card-body">
    ...
    const columns = ref([
        ...
        { title: 'Action', data: null, render: (data,type,row) => {
            return `
                ...
                <a class="btn btn-primary me-1" href="#" onclick="ShowFournisseurFunction(${row.id})">
                    <i class="fas fa-edit me-2"></i>
                </a>

                <a class="btn btn-danger" href="#" onclick="DeleteFournisseurFunction(${row.id})">
