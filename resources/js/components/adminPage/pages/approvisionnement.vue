<template>
    <div class="dashboard-main-body">
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <h6 class="fw-semibold mb-0">Liste des Approvisionnements</h6>
            <ul class="d-flex align-items-center gap-2">
                ...
                <li>-</li>
                <li class="fw-medium">Approvisionnements</li>
            </ul>
        </div>
                ...
                <div class="card border-0 shadow-sm" style="border-left:4px solid #0d6efd !important;">
                    <div class="card-body d-flex align-items-center gap-3">
                        <div class="rounded-circle d-flex align-items-center justify-content-center"
                            ...
                            <iconify-icon icon="solar:box-bold" style="color:#0d6efd;font-size:22px;"></iconify-icon>
                        </div>
                        <div>
                ...
                <div class="card border-0 shadow-sm" style="border-left:4px solid #ffc107 !important;">
                    <div class="card-body d-flex align-items-center gap-3">
                        <div class="rounded-circle d-flex align-items-center justify-content-center"
                            ...
                            <iconify-icon icon="solar:clock-circle-bold" style="color:#ffc107;font-size:22px;"></iconify-icon>
                        </div>
                        <div>
                            <p class="mb-0 text-muted small">En attente</p>
                            <h5 class="fw-bold mb-0" style="color:#ffc107;">{{ stats.enAttente }}</h5>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card border-0 shadow-sm" style="border-left:4px solid #28a745 !important;">
                    <div class="card-body d-flex align-items-center gap-3">
                        <div class="rounded-circle d-flex align-items-center justify-content-center"
                            ...
                            <iconify-icon icon="solar:check-circle-bold" style="color:#28a745;font-size:22px;"></iconify-icon>
                        </div>
                        <div>
                            <p class="mb-0 text-muted small">Livrés</p>
                            <h5 class="fw-bold mb-0" style="color:#28a745;">{{ stats.livres }}</h5>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-header d-flex flex-wrap align-items-center justify-content-between gap-3">
                <div class="d-flex gap-2">
                    <select v-model="filterStatus" class="form-select form-select-sm" style="width:auto;">
                        ...
                        <option value="livrer">Livrés</option>
                    </select>
                </div>
                <button @click="showModal" class="btn btn-sm btn-primary-600">
                    <i class="ri-add-line"></i> Nouvel Approvisionnement
                </button>
            </div>
            <div class="card-body">
                <DataTable :data="filteredAppros" :columns="columns" />
            </div>
        </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12" v-if="data.items.length > 0">
                                <div class="card border-0 text-end pe-3 py-2" style="background:#f0f4ff;">
                                    <span class="text-muted small">Montant total de la commande</span>
                    ...
                    <div class="modal-body" v-if="detailAppro">
                        ...
                        <div class="row g-2 mb-3">
                                ...
                                <p class="mb-0">
                                    <span class="badge"
                                        :style="detailAppro.status === 'livrer'
                                            ? 'background:#d4edda;color:#28a745;'
                                            : 'background:#fff3cd;color:#856404;'">
                                        {{ detailAppro.status === 'livrer' ? '✓ Livré' : '⏳ En attente' }}
                                    </span>
                                </p>
                            </div>
                            <div class="col-sm-4">
                            ...
                            <div class="col-sm-4">
                                ...
                                <p class="fw-bold mb-0">{{ detailAppro.user?.fullname }}</p>
                            </div>
                            <div class="col-sm-4">
                        ...
                        <div v-else class="alert mb-0" style="background:#d4edda;color:#28a745;">
...
<script setup>
    ...
    const columns = ref([
        ...
        },
        {
            ...
            render: (data, type, row) => row.status === 'livrer'
                ? `<span class="badge" style="background:#d4edda;color:#28a745;">✓ Livré</span>`
        ...
        },
        {
            ...
            render: (data, type, row) => `
                ...
                <a class="btn btn-success btn-sm me-1" href="#"
    ...
    async function AllApproFunction() {
        await getData('/aprovisionnements').then(res => {
    ...
    async function AddApproFunction() {
        ...
        await postData('/aprovisionnements', payload).then(res => {
